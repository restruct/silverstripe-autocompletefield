...
namespace Restruct\Silverstripe\AutoComplete;
    ...
    extends TextField
{
    ...
    {
        Requirements::javascript('restruct/silverstripe-autocompletefield:client/bower_components/devbridge-autocomplete/dist/jquery.autocomplete.js');
        Requirements::javascript('restruct/silverstripe-autocompletefield:client/js/autocomplete-init.js');
    }
